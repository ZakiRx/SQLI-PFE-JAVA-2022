...
import org.sqli.authentification.dto.response.ResponseException;
...
public class CustomResponseExceptionMessage extends ResponseEntityExceptionHandler {
    ...
    public final ResponseEntity<Object> exceptionHandler(AuthenticationException ex) {
        return new ResponseEntity<>(new ResponseException(ex.getMessage(),HttpStatus.BAD_REQUEST), HttpStatus.BAD_REQUEST);
    }
}
